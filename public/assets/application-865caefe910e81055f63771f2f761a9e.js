...
(function() {
  var ShowSubvariety, ShowVariety;

  ShowVariety = {
    hideVariety: function() {
      return $('#dogsVarieties').hide();
    },
    replaceVarietyDiv: function(data, requestStatus, xhrObject) {
      return $('#dogsVarieties').html(data).show();
    },
    error: function(xhrObj, textStatus, exception) {
      return alert('Error!');
    },
    getVarietiesDiv: function() {
      var breed;
    ...
    setup: function() {
      ...
      return $(document).on('change', '#breed', ShowSubvariety.hideSubvariety);
    }
  };
  ...
  ShowSubvariety = {
    hideSubvariety: function(data) {
      $('#dogsSubvariety').html(data);
      return $('#dogsSubvariety').hide();
    },
    replaceSubvarietyDiv: function(data, requestStatus, xhrObject) {
      return $('#dogsSubvariety').html(data).show();
    },
    error: function(xhrObj, textStatus, exception) {
      return alert('Error!');
    },
    getSubvarietyDiv: function() {
      var variety;
    ...
    setup: function() {
      return $(document).on('change', '#variety', ShowSubvariety.getSubvarietyDiv);
    }
  };
